...
public class FragmentSongBindingImpl extends FragmentSongBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rvSong, 1);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.SongFragmentAccessObject == variableId) {
            setSongFragmentAccessObject((com.st.stmusic.fragments.SongFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSongFragmentAccessObject(@Nullable com.st.stmusic.fragments.SongFragment SongFragmentAccessObject) {
        this.mSongFragmentAccessObject = SongFragmentAccessObject;
    }
    ...
    /* flag mapping
        flag 0 (0x1L): SongFragmentAccessObject
        flag 1 (0x2L): null
    flag mapping end*/
    //end
}